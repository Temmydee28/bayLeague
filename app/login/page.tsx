...
import { Trophy, Lock, User, ArrowRight, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        <div className="bg-bg-card border border-white/10 p-8 rounded-2xl shadow-2xl relative transition-all hover:border-primary/20">
          <div className="text-center mb-10">
            ...
            <p className="text-text-muted mt-2">Log in to manage your tournaments</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary hover:bg-primary/90 text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary/20 transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2"
            >
